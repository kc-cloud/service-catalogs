...
import { V1Pod, V1Service, V1ConfigMap, V1Deployment, V1LimitRange, V1ResourceQuota, V1ReplicaSet, V2HorizontalPodAutoscaler, V1Job, V1CronJob, V1Ingress, V1StatefulSet, V1DaemonSet, PodStatus } from '@kubernetes/client-node';
